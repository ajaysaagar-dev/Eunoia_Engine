...
(window as any).EunoiaEngine_ShadowGenerators = [];
...
export async function ShadowGenerator_(light: IShadowLight, resolution: 2 | 4 | 8 | 16 | 32 | 64 | 128 | 256 | 512 | 1024 | 2048 | 4096 = 512) {
    ...
    ((window as any).EunoiaEngine_ShadowGenerators as ShadowGenerator[]).push(SG);
    return SG;
}

export async function ShadowEnable_(mesh: AbstractMesh) {
    ((window as any).EunoiaEngine_ShadowGenerators as ShadowGenerator[]).forEach((SG) => {
